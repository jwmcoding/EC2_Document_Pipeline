...
class RawSalesforceExportConnector(FileSourceInterface):
    ...
    def __init__(self,
        ...
        Args:
            ...
            content_documents_csv: Path to content_documents.csv
    ...
    def _load_all_mappings(self):
        ...
        for _, row in cv_df.iterrows():
            cv_id = row['Id']
            # Only process latest versions (IsLatest can be bool True or string 'true')
            ...
            if isinstance(is_latest, bool):
                ...
                continue  # Skip if not bool or string
