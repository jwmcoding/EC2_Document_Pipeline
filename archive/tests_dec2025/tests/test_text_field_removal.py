...
# NOTE: Text is intentionally NOT stored in Pinecone (by design)
# - Text removed from metadata to prevent 40KB limit errors
# - Text not stored at "top level" (Pinecone doesn't support this)
# - Text not needed for search/retrieval (embeddings contain semantic information)
# - Frontend does not display chunk text (original requirement was mistaken)
