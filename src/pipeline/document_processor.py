...
def truncate_text_for_metadata(text: str, max_bytes: int = 37 * 1024) -> str:
    """
    ...
    def process_document(self, doc_metadata: DocumentMetadata, namespace: str = "documents") -> Dict[str, Any]:
        ...
        try:
            ...
            for i, chunk in enumerate(chunk_data):
                ...
                # Add truncated text field to metadata (37KB limit for safety margin)
                chunk_text = chunk['text']
                truncated_text = truncate_text_for_metadata(chunk_text, max_bytes=37 * 1024)
            ...
            # Extract docling OCR decision metadata if available
            if parsed_content.metadata:
                ...
                for key in [
                    ...
                    if key in parsed_content.metadata:
                        docling_metadata[key] = parsed_content.metadata[key]
                if docling_metadata:
